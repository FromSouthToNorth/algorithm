...
/**
 * <h1>799. 香槟塔</h1>
 * <p>我们把玻璃杯摆成金字塔的形状，其中 <strong>第一层</strong> 有 1 个玻璃杯， <strong>第二层</strong> 有 2 个，依次类推到第 100 层，每个玻璃杯 (250ml) 将盛有香槟。</p>
 ...
 * <h2>提示:</h2>
 * <ul>
 *     <li>0 <= poured <= 10<sup>9</sup></li>
 *     <li>0 <= query_glass <= query_row < 100</li>
 * </ul>
 *
 * @author 力扣（LeetCode）
 * @author hy
 * @see <a href="https://leetcode.cn/problems/champagne-tower/">https://leetcode.cn/problems/champagne-tower/</a>
 */
